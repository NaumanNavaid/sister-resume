...
import { Mail, Phone, MapPin, Calendar, Award, BookOpen, Briefcase, User, FileText } from 'lucide-react';
                    ...
                    <div className=" space-y-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="border-l-4 border-gray-400 pl-6 pb-6">
                                    <div className="flex items-center mb-2">
                                        <Calendar className="w-4 h-4 text-gray-500 mr-2" />
                    ...
                    <div className="space-y-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-gray-600">
                                    <h3 className="font-semibold text-gray-800">Fish Identification and Quality Assesment</h3>
                                    <p className="text-gray-600 text-sm">At Multiple Locations: Imtiaz Super Market, Musa Colony Fish Market</p>
